  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item has-treeview">
          <a href="<?=base_url('pengadaan')?>" class="nav-link <?=isset($active_menu_pgd)?$active_menu_pgd:'' ?>" class="nav-link <?=isset($active_pengadaan)?$active_pengadaan:'' ?>">
