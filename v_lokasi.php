  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">
          <button type="button" data-toggle="modal" data-target="#modal-default" class="btn btn-block bg-gradient-primary">Tambah Ruangan</button>
        </h3>
        ...
        <div class="modal-body">
          <form class="form-horizontal" action="<?=base_url('lokasi/simpan')?>" autocomplete="off" method="post">
            <div class="form-group">
              <label for="nama_lokasi" class="col-sm-6 col-form-label">Nama Ruangan</label>
              <div class="col-sm-12">
                <input type="text" class="form-control" placeholder="Masukan Nama Ruangan" name="nama_lokasi" required autofocus>
              </div>
            </div>
            <!-- /.card-body -->                
          </div>
